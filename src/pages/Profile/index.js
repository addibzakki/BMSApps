...
const Profile = ({navigation}) => {
  ...
  const handleLogOut = () => {
    axios
      .post('https://mynet.mmproperty.com/api/unsubscribed_notif', {
  ...
  if (
    !(
      LoginReducer.form.profile.photo == '' ||
      LoginReducer.form.profile.photo == null
    )
  ) {
    imageSource = (
      <Image
        source={{
          uri:
            'http://mynet.mmproperty.com/img/employee/' +
            LoginReducer.form.profile.photo,
        }}
  ...
  return (
    <View style={styles.wrapper.page}>
      ...
      <View
        ...
        <TouchableOpacity
          onPress={() => {
            sendNotificatioOneSignal('bms://app/Profile', [
              '0ab010ce-a342-4297-981d-8da5799d4f5a',
            ]);
          }}
          style={{
