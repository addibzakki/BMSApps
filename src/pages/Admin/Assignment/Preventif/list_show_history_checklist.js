...
const AdminPreventifListShowHistoryChecklist = ({navigation}) => {
  ...
  const getData = async () => {
    try {
      const res = await PreventiveAPIService.getAllCheckStandarByTransCode(
        PreventifReducer['trans_code'],
      );
...
export default AdminPreventifListShowHistoryChecklist;
