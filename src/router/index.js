...
const Router = () => {
  return (
    <Stack.Navigator>
      ...
      />
      <Stack.Screen
        name="AdminOvertimeList"
        component={AdminOvertimeList}
        options={{
          headerShown: false,
        }}
      />
      <Stack.Screen
        name="AdminOvertimeShow"
        component={AdminOvertimeShow}
        options={{
          headerShown: false,
        }}
      />
      <Stack.Screen
        name="AdminOvertimeReport"
        component={AdminOvertimeReport}
        options={{
          headerShown: false,
        }}
      />
      <Stack.Screen
        name="AdminOvertimeResult"
        component={AdminOvertimeResult}
        options={{
          headerShown: false,
        }}
      />
      ...
      />
      <Stack.Screen
        name="AdminHelpdeskPurpose"
        component={AdminHelpdeskPurpose}
        options={{
          headerShown: false,
        }}
      />
      ...
      <Stack.Screen
        name="FormModify"
        component={FormModify}
        options={{
          headerShown: false,
        }}
      />
      <Stack.Screen
        name="FormConfirmItem"
        component={FormConfirmItem}
        options={{
          headerShown: false,
        }}
      />
      <Stack.Screen
        name="FormModifyFixItem"
        component={FormModifyFixItem}
        options={{
          headerShown: false,
        }}
      />
      <Stack.Screen
        name="FormReleaseItem"
        component={FormReleaseItem}
        options={{
          headerShown: false,
        }}
      />
