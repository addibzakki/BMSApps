    ...
    <View style={{paddingHorizontal: 15}}>
      <View
        ...
        <View style={{flex: 1}}>
          <InputDateRangeFilter
            ...
            value={startTime ? moment(startTime).format('DD-MM-YYYY') : ''}
            editable={false}
      ...
      <View style={{flexDirection: 'row', marginBottom: 10}}>
        <TouchableOpacity
          ...
          <Ionicons name="md-checkmark-outline" size={15} color="white" />
          <Text
            style={{
              color: 'white',
              fontWeight: 'bold',
        ...
        <TouchableOpacity
          ...
          <Ionicons name="md-document-text-outline" size={15} color="white" />
          <Text
            style={{
              color: 'white',
              fontWeight: 'bold',
        ...
        <TouchableOpacity
          ...
          <Ionicons name="md-close-outline" size={15} color="white" />
          <Text
            style={{
              color: 'white',
              fontWeight: 'bold',
