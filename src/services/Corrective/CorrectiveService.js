...
const CorrectiveAPIService = {
  ...
  getListRemarkItemCorrective: function(params) {
    return axios.post('/get_list_remark_item', params);
  },
  ...
  getListPurpose: function(params) {
    return axios.get('/get_list_purpose');
  },
